...
<body>
  <header>
    ...
    <nav>
        <a href="reservas_dashboard.html">Volver al Dashboard de Reservas</a> |
    ...
    <table border="1" style="width:100%; border-collapse: collapse;">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style="font-weight:bold; color:<?php echo ($reserva['estado_reserva'] === 'Confirmada' ? 'green' : ($reserva['estado_reserva'] === 'Cancelada' ? 'red' : 'orange')); ?>">
          ...
          <td>
            <?php if ($reserva['estado_reserva'] === 'Confirmada'): ?>
                <a href="modificar_reserva.php?id=<?php echo $reserva['reserva_id']; ?>">Modificar</a> |
                <a href="procesar_cancelacion.php?id=<?php echo $reserva['reserva_id']; ?>" onclick="return confirm('¿Está seguro de cancelar esta reserva (ID: <?php echo $reserva['reserva_id']; ?>)? Esta acción no se puede deshacer.');">Cancelar</a>
                <br>
                <!-- Futuro: <a href="procesar_checkin.php?id=<?php echo $reserva['reserva_id']; ?>">Check-in</a> -->
            <?php elseif ($reserva['estado_reserva'] === 'Ocupada'): // Suponiendo que implementas este estado ?>
                 <!-- Futuro: <a href="procesar_checkout.php?id=<?php echo $reserva['reserva_id']; ?>">Check-out</a> -->
            <?php else: ?>
                (Sin acciones)
            <?php endif; ?>
          </td>
